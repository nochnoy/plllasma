...
export class Message {
  ...
  isEditMode = false; // юзер ткнул на кнопку "редактировать", появилась форма редактирования сообщения
  isReplyMode = false; // юзер ткнул на кнопку "ответить", появилась форма ответа
  canDeselect = true; // становится false до закрытия формы редактирования или ответа
